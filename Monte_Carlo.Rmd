...
# Pricing American Options
  ...
  *  $T \in [0,T]$ be a class of admissible stopping times.
  ...
  6. Regression-Based Methods and Weights
    ...
    * The coefficients $\beta_{ir}$ could be estimated from observations of pairs $(X_{ij}, V_{i+1}(X_{i+1,j})), j=1,...,b$, each consisting of the state at time i and the corresponding option value at time i+1. 
