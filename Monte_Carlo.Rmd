...
.	Variance Reduction Techniques
  o	control variates
    ...
    * Let $Y_1, Y_2, Y_n$ be outputs from some replications. Now, for each replication we compute $X_i$. Assume that $E[X_i]$ is known. Then for any b: $Y_i(b) = Y_i - b(X_i-E[X])$. Then the sample mean of $E[Y(b)] = $
